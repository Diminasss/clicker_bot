...
def bot():
    ...
    bot.send_message(chat_id=823899679, text="Пизда рулю и седлу", reply_markup=lottery_markup)
    ...
    while True:
        try:
            ...
            LOGGER.error(f"{e}")
            bot.send_message(chat_id=823899679, text=f"Пизда рулю и седлу {e}")
